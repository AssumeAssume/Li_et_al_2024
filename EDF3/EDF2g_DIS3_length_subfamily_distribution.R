...
de_l1 <- fread("/analysis/lixf/RNA/human/K562/KnockDown/DIS3/6-LINE1M/Combine_RepeatMasker_Unique.Deseq2.DIS3_vs_SAFE.p_0.05.L1.annotated.bed")
de_l1_df <- de_l1 %>% mutate(length = end - start,group = "sgDIS3 DE-L1", subfamily  = str_split_fixed(TE_ID,"_chr",2)[,1])
...
ggsave("dis3_length_distribution.pdf",height=1.5,width = 3,useDingbats = F)
