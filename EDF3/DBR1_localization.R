...
l1 <- fread("/analysis/lixf/RNA/human/K562/KnockDown/DBR1/6-LINE1M/Combine_RepeatMasker_Unique.Deseq2.DBR1_vs_SAFE.p_0.05.annotated.bed")
...
ggsave("DBR1_localization.pdf",width = 2,height = 1)
