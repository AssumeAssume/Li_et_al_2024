...
dir=/analysis/lixf/sgRNA/human/LINE_screening_combine/Nature_revision/Referee3/Figure2g_add_down_gene/absolute_distance

#sizeList=(0 1 2 4 8 16 32 64 128 256 512 1024 2048 )
GeneBed=/analysis/lixf/RNA/human/K562/KO/CTBP1/5-DESeq2/KnownGene/CTBP1_downgene_removeContig.tss.sort.bed
...
prefix=CTBP1_downGene_K27ac_increased_L1
outdir=${dir}/${prefix}
mkdir -p ${outdir}
